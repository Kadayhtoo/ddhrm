  ...
  <v-container fluid class="invoice-page">
    <div class="invoice-wrapper">
      ...
      <v-row>
        <v-col cols="6">
          ...
          <div v-if="invoice.client">
            ...
            <div>{{ invoice.client.country_name }}</div>
          </div>
        </v-col>
      ...
      <div class="invoice-date">
        Invoice Date:
        {{ invoice.issue_date ? new Date(invoice.issue_date).toLocaleDateString('en-GB') : today }}
      </div> 
      ...
      <v-row class="mt-10">
        <v-col cols="7">
          <div class="thank-you" v-html="invoice.terms || defaultTerms"></div>
        </v-col>
        <v-col cols="5">
          <div class="summary-box">
            ...
            <div class="summary-row">
              <span>Discount</span>
              <span>
                {{ formatAmount(invoice.discount_value) }}
                {{
